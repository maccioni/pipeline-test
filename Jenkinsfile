...
//            }
    ...
    post {
      always {
          ...
          slackSend(channel: 'demo-notifications', message: "Finished: Job '${env.JOB_NAME} [${env.BUILD_NUMBER}]' at ${new Date() with State: ${STATE}.", username: 'fabriziomaccioni', token: "${env.SLACK_TOKEN}", teamDomain: 'fwd-net')
      }
      success {
