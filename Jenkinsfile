...
//            }
    ...
    post {
      always {
          ...
          slackSend(channel: 'demo-notifications', message: 'test message from jenkins using token', username: 'fabriziomaccioni', token: 'GnbPV5e2SVkTkyMiRXaCFEXK', teamDomain: 'fwd-net')
      }
      success {
